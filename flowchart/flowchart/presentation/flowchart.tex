...
\mod.set and draw(first guess method, FIRST GUESS METHOD, 0, 0)
...
\mod.set height(7.5cm)

\mod.set and place2(stepping algorithm, STEPPING ALGORITHM,  right= 3cm of forward model)
