...
\usepackage{lmodern}
\usepackage{amsmath}
\usepackage[paperwidth=240mm, paperheight=215mm, margin=5mm]{geometry}
...
\mod.set and place(min_hgt, NEW TERMINUS ELEVATION {$z_\text{min}(t+1)$}, below = 1cm of length)
...
% terminus elevation
\mod.set and place(min_hgt_t, TERMINUS ELEVATION {$z_\text{min}(t)$}, right = 7.75cm of specmb)
