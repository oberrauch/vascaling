    ...
    \label{sub:results_projection}
      ...
      \begin{table}[htp]
        ...
        \begin{tabular}{@{}rlclcclcc@{}}  
          \toprule
          {} & \phantom{a} & \multirow{2}{*}{\shortstack{\textbf{Geodetic}\\\textbf{observations}\\[5pt]{}[\si{\milli\meter\waterequivalent\per\year}]}} & \phantom{a} & \multicolumn{2}{c}{\textbf{V/A scaling}} & \phantom{a} & \multicolumn{2}{c}{\textbf{Flowline}} \\
