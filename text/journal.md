...
The cumulative specific mass balance over the 31-year climate period centred around $t^*$ must be zero, given a successful $\mu^*$ calibration. Thereby the mass balance bias $\beta^*$ is not applied. @ASK
